"""Check the RM-native Paxos port (independent of generate.py/native VM)."""
import argparse
import json
...
def main():
    ...
    result=check(protocol,args.backend,directory=args.out,depth=args.depth,timeout=args.timeout)
